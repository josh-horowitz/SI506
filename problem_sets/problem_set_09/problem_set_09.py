...
class Languages():
    ...
    def get_speakers(self, language):
        ...
        """
        return self.language_database[language]
...
def fill_language_database(species_data, language_database):
    ...
    for data in species_data:
        if data['name'] != 'Droid':
            data['homeworld'] = get_swapi_resource(data['homeworld'])['name']
            language_database.add_language(data)
...
def main():
    ...
    language_database = fill_language_database(species_data, language_list)
