...
class Person:
    ...
    Methods:
        jsonable: return JSON-friendly dict representation of the object
    """
    def __init__(self, url, name, birth_year, height, mass, homeworld=None):
...
def main():
    ...
    # step 5
    for key in tatooine_data.keys():
        swapi_tatooine.update({key:tatooine_data[key]})
    ...
    print(f'The name of the planet is {tatooine}')
    # step 7
