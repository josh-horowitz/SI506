...
def main():
    ...
    lars_data['species_name'] = lars_species['name']
    print(f"Owen Lars data w/Species = {lars_data}")


    # Update values in < lars >.
    for data in lars_data:
        if data in lars.keys():
            lars[data] = lars_data[data]
