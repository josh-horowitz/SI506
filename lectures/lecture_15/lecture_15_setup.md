...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_15/
cp lecture_15_setup.md lecture_15.md lecture_15.py rotten_tomatoes_ratings.csv scary_films.csv ../Documents/umich/courses/SI506/lectures/lecture_15/
cd ../Documents/umich/courses/SI506/lectures/lecture_15/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_15`.

3. Copy (`cp`) the downloaded files to the `lecture_15` directory.
...
4. Navigate (`cd`) to your `lecture_15` directory.

5. Confirm "that the contents of the `lecture_15` directory are as expected (i.e., it contains
...
1. Hover over `lecture_15.md`, right-click, and select "Open Preview".
2. Hover over `lecture_15.py`, right-click, and select "Open to the Side".
