...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_12/
cp lecture_12_setup.md lecture_12.md lecture_12.py resnick-citations.csv umsi-faculty.csv ../Documents/umich/courses/SI506/lectures/lecture_12/
cd ../Documents/umich/courses/SI506/lectures/lecture_12/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_12`.

3. Copy (`cp`) the downloaded files to the `lecture_12` directory.
...
4. Navigate (`cd`) to your `lecture_12` directory.

5. Confirm "that the contents of the `lecture_12` directory are as expected (i.e., it contains
...
1. Hover over `lecture_12.md`, right-click, and select "Open Preview".
2. Hover over `lecture_12.py`, right-click, and select "Open to the Side".
