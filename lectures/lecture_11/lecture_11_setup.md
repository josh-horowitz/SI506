...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_11/
cp lecture_11_setup.md lecture_11.md lecture_11.py resnick-publications.csv umsi-faculty.txt ../Documents/umich/courses/SI506/lectures/lecture_11/
cd ../Documents/umich/courses/SI506/lectures/lecture_11/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_11`.

3. Copy (`cp`) the downloaded files to the `lecture_11` directory.
...
4. Navigate (`cd`) to your `lecture_11` directory.

5. Confirm "that the contents of the `lecture_11` directory are as expected (i.e., it contains
...
1. Hover over `lecture_11.md`, right-click, and select "Open Preview".
2. Hover over `lecture_11.py`, right-click, and select "Open to the Side".
